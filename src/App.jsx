...
function App() {
  ...
  function sortCountries(list) {
    return list.sort((a, b) => {
      if (sortBy === "gold-desc") return b.gold.page_value - a.gold.page_value || a.name.localeCompare(b.name);
      if (sortBy === "gold-asc") return a.gold.page_value - b.gold.page_value || a.name.localeCompare(b.name);
      ...
      <Flex p="2" pl="8" className="fixedHeader" justify="between" align="center">
        ...
        <Flex gap="3" align="center">
          <Select.Root value={sortBy} onValueChange={setSortBy}>
            ...
            <Select.Content>
              <Select.Item value="gold-desc">Most golds</Select.Item>
              <Select.Item value="gold-asc">Least golds</Select.Item>
              <Select.Item value="alpha-asc">Alphabetical A-Z</Select.Item>
              <Select.Item value="alpha-desc">Alphabetical Z-A</Select.Item>
            </Select.Content>
          </Select.Root>
